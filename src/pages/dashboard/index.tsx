...
const Index: NextPageWithLayout = () => {
  const [activeConsultancy, setActieConsultancy] =
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {consultancy.isLoading ? (
                    ...
                    <div className="w-full text-center text-2xl font-bold text-white">
                      <span>{activeConsultancy?.length}</span>/
                      <span>{consultancy.data?.length}</span>
                    </div>
                  )}
                </div>
              </div>
        ...
        ) : null}
        {
          newBooking ? (
            <div className="w-full">
              <BookingForm
                showCancel={true}
                callbackFn={() => setNewBooking(false)}
              />
            </div>
          ) : null
        }
